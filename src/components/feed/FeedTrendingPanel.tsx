  ...
  return <div className="space-y-6">
      ...
      delay: 0.2
        ...
        <Card className="overflow-hidden border-[#2a2f45]/50 bg-[#1c1f2e]/60 backdrop-blur-lg">
          <CardHeader className="pb-2 bg-zinc-900">
          ...
          <CardContent className="p-0">
            <div className="px-4 bg-zinc-900">
              {trends.map((trend, index) => <div key={index}>
                  <div className="py-3 flex items-center justify-between bg-zinc-900">
                    ...
                    <div className="flex items-center">
                      {trend.trending && <div className="mr-2">
            ...
            <div className="px-4 pt-2 pb-4 bg-zinc-900">
              <Button variant="ghost" size="sm" className="w-full justify-between text-blue-400 hover:text-blue-300 text-xs" asChild>
      ...
      delay: 0.3
        ...
        <Card className="overflow-hidden border-[#2a2f45]/50 backdrop-blur-lg bg-zinc-900">
          <CardHeader className="pb-2 bg-zinc-900">
          ...
          <CardContent className="p-0">
            <div className="px-4">
              {trendingUsers.map((user, index) => <div key={index}>
                  <div className="py-3 flex items-center justify-between bg-zinc-900">
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white font-semibold text-sm">
                        {user.avatar ? <img src={user.avatar} alt={user.name} className="h-full w-full object-cover rounded-full" /> : user.name.charAt(0)}
                      </div>
                      <div>
                    ...
                    <Button variant="outline" size="sm" className="h-7 rounded-full text-xs border-[#2a2f45] hover:bg-blue-500/10 hover:border-blue-500/40 hover:text-blue-400">
                      Follow
                    </Button>
                  </div>
            ...
            <div className="px-4 pt-2 pb-4 bg-zinc-900">
              <Button variant="ghost" size="sm" className="w-full justify-between text-purple-400 hover:text-purple-300 text-xs" asChild>
      ...
      duration: 0.4,
      delay: 0.4
    }} className="px-4 py-5 border border-[#2a2f45]/50 backdrop-blur-lg bg-zinc-900 rounded-lg">
        ...
        <Button className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white border-0" size="sm">
          Upgrade to Premium
        </Button>
      </motion.div>
    </div>;
