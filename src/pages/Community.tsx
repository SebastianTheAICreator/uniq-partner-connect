...
const CommunityPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 bg-[#222222] flex flex-col">
      <Navbar />
        ...
        {!selectedCategory ? (
          <div className="bg-[#222222]">
              ...
              <div className="container mx-auto px-6 py-32 relative z-10">
                ...
                >
                  ...
                  >
                    ...
                    <ActionButton 
                      variant="secondary" 
                      className="py-3 px-6 text-white bg-white/10 hover:bg-white/20 backdrop-blur-lg border border-white/10 transition-all duration-300 rounded-xl"
                    >
                    ...
                    <div className="flex flex-col md:flex-row gap-6 items-stretch">
                      <div className="flex-1 relative rounded-2xl overflow-hidden bg-[#222222] border border-white/5 shadow-[0_0_25px_rgba(59,130,246,0.1)] hover:shadow-[0_0_35px_rgba(59,130,246,0.15)] transition-all duration-300">
                        <Input 
                          ...
                          className="w-full pl-14 py-7 text-lg bg-transparent border-none text-white placeholder:text-white/40 focus:ring-2 focus:ring-blue-500/30" 
                          value={searchTerm} 
                      ...
                      <div className="flex gap-2 items-center">
                        <ActionButton 
                          variant="primary" 
                          className="p-4 hover:bg-white/10 rounded-xl transition-colors h-full aspect-square flex items-center justify-center bg-[#222222] border border-white/5"
            ...
            {viewType === 'featured' && featuredCommunity && (
              <div className="py-16 bg-[#1A1F2C]/80">
                <div className="container mx-auto px-6">
                  <motion.div 
                    initial={{ opacity: 0, y: 20 }} 
                    whileInView={{ opacity: 1, y: 0 }} 
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-3">
                          {featuredCommunity.interests.slice(0, 3).map((interest, i) => (
                            <Badge key={i} variant="outline" className="bg-gradient-to-r from-blue-500/10 to-emerald-500/10 text-white/90 border-none">
                              {interest}
                            </Badge>
                          ))}
                        </div>
                      ...
                      <div className="pt-4">
                        <div className="flex flex-col sm:flex-row gap-4">
                          <ActionButton
                            ...
                            className="flex-1 group flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-500 to-emerald-500 hover:from-blue-600 hover:to-emerald-600 text-white font-inter rounded-xl py-4 hover:shadow-lg transition-all duration-300"
                          >
                          ...
                          <ActionButton
                            className="flex-1 group flex items-center justify-center space-x-2 bg-white/5 hover:bg-white/10 text-white font-inter rounded-xl py-4 transition-all duration-300 border border-white/10"
                          >
                          ...
                          <div className="p-6 space-y-5">
                            <div className="flex items-center justify-between">
                              ...
                              {community.memberCount > 100 && (
                                <Badge className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 text-white/90 border-none">
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2 mb-4">
                                {community.interests.map((interest, i) => (
                                  <span key={i} className="text-xs px-3 py-1 rounded-full bg-gradient-to-r from-blue-500/10 to-emerald-500/10 text-white/90">
                                    {interest}
                                  </span>
                                ))}
                              </div>
                              ...
                              <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="text-white/60 text-sm flex items-center group-hover:text-blue-400 transition-colors mt-2"
                            ...
                            <ActionButton
                              ...
                              className="w-full group flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-400 to-emerald-400 hover:from-blue-500 hover:to-emerald-500 text-white font-inter rounded-lg py-3.5 hover:shadow-lg transition-all duration-300"
                            >
                              <Heart className="h-5 w-5 group-hover:scale-110 transition-transform" />
